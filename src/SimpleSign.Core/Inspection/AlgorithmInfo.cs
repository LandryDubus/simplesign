...
public sealed class AlgorithmInfo
{
    ...
    private static string MapUriToName(string uri) => uri switch
    {
        ...
        Constants.XmlDSigUrls.Sha3_256Digest => "SHA3-256",
        Constants.XmlDSigUrls.Sha3_384Digest => "SHA3-384",
        Constants.XmlDSigUrls.Sha3_512Digest => "SHA3-512",
    ...
    private static string MapOidToName(string oid) => oid switch
    {
        ...
        Constants.Oids.Sha3_256 => "SHA3-256",
        Constants.Oids.Sha3_384 => "SHA3-384",
        Constants.Oids.Sha3_512 => "SHA3-512",
