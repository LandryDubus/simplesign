...
public sealed class BrasilCpfCnpjTests
{
    ...
    public void IsValidCpf_KnownValid_ReturnsTrue(string cpf) => IcpBrasilChainValidator.IsValidCpf(cpf).ShouldBeTrue();

    [Theory(DisplayName = "IsValidCpf rejects wrong-length input")]
    [InlineData("")]
    [InlineData("1234567890")]   // 10 digits
    [InlineData("123456789012")] // 12 digits
    public void IsValidCpf_WrongLength_ReturnsFalse(string cpf) => IcpBrasilChainValidator.IsValidCpf(cpf).ShouldBeFalse();
    ...
    public void IsValidCpf_NonDigit_ReturnsFalse(string cpf) => IcpBrasilChainValidator.IsValidCpf(cpf).ShouldBeFalse();

    [Theory(DisplayName = "IsValidCpf rejects all-same-digit sequences")]
    [InlineData("00000000000")]
    [InlineData("11111111111")]
    [InlineData("99999999999")]
    public void IsValidCpf_AllSameDigit_ReturnsFalse(string cpf) => IcpBrasilChainValidator.IsValidCpf(cpf).ShouldBeFalse();
    ...
    public void IsValidCpf_BadFirstCheckDigit_ReturnsFalse(string cpf) => IcpBrasilChainValidator.IsValidCpf(cpf).ShouldBeFalse();
    ...
    public void IsValidCnpj_KnownValid_ReturnsTrue(string cnpj) => IcpBrasilChainValidator.IsValidCnpj(cnpj).ShouldBeTrue();
    ...
    public void IsValidCnpj_WrongLength_ReturnsFalse(string cnpj) => IcpBrasilChainValidator.IsValidCnpj(cnpj).ShouldBeFalse();
    ...
    public void IsValidCnpj_NonDigit_ReturnsFalse(string cnpj) => IcpBrasilChainValidator.IsValidCnpj(cnpj).ShouldBeFalse();

    [Theory(DisplayName = "IsValidCnpj rejects all-same-digit sequences")]
    [InlineData("00000000000000")]
    [InlineData("11111111111111")]
    [InlineData("99999999999999")]
    public void IsValidCnpj_AllSameDigit_ReturnsFalse(string cnpj) => IcpBrasilChainValidator.IsValidCnpj(cnpj).ShouldBeFalse();
